...
import pingan.com.cn.pojo.Brand;
import pingan.com.cn.service.BrandService;
...
public class BrandController {
    ...
    public Result<List<Brand>> findAll(){
        ...
        System.out.println("睡醒之前的线程："+Thread.currentThread().getName());
        try {
            System.out.println("睡醒之后的线程："+Thread.currentThread().getName());
